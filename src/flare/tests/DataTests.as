package flare.tests {
  ...
  public class DataTests extends TestCase {
    ...
    public function testCreateNodesOnList():void {
      data = new Data();
    ...
    public function testCreateEdgesOnList():void {
      data = new Data();
      for (var i:uint = 0; i < N; ++i) {
        data.addNode({id: i});
        assertEquals(data.nodes.length, i + 1);
    ...
    public function testCreateNodes():void {
      data = new Data();
      for (var i:uint = 0; i < N; ++i) {
        data.addNode({id: i});
        assertEquals(data.nodes.length, i + 1);
    ...
    public function testCreateWithDefaults():void {
      ...
      assertFalse(_t == curr.props.temp);
      assertFalse(_ea == e.alpha);
    }

    public function testContainsNodes():void {
      testCreateNodes();
      for (var i:uint = 0; i < N; ++i) {
    ...
    public function testRemoveEdges():void {
      var e:EdgeSprite;
    ...
    public function testRemoveNodesWithEdges():void {
