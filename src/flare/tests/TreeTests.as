package flare.tests {
  ...
  public class TreeTests extends TestCase {
    ...
    private var a:NodeSprite, b:NodeSprite, c:NodeSprite, d:NodeSprite, e:NodeSprite, f:NodeSprite, g:NodeSprite;
    private var ab:EdgeSprite, bc:EdgeSprite, cd:EdgeSprite, ae:EdgeSprite, bf:EdgeSprite, cg:EdgeSprite, dg:EdgeSprite, ef:EdgeSprite, fg:EdgeSprite;
    ...
    protected function setup():void {
      ...
      ab = data.addEdgeFor(a, b);
      ab.name = "ab";
      ab.data = {w: 1};
      bc = data.addEdgeFor(b, c);
      bc.name = "bc";
      bc.data = {w: 10};
      cd = data.addEdgeFor(c, d);
      cd.name = "cd";
      cd.data = {w: 1};
      ae = data.addEdgeFor(a, e);
      ae.name = "ae";
      ae.data = {w: 4};
      bf = data.addEdgeFor(b, f);
      bf.name = "bf";
      bf.data = {w: 5};
      cg = data.addEdgeFor(c, g);
      cg.name = "cg";
      cg.data = {w: 5};
      dg = data.addEdgeFor(d, g);
      dg.name = "dg";
      dg.data = {w: 0.1};
      ef = data.addEdgeFor(e, f);
      ef.name = "ef";
      ef.data = {w: 1};
      fg = data.addEdgeFor(f, g);
      fg.name = "fg";
      fg.data = {w: 1};
    }
    ...
    //  |       /
    //  e--f--g
    public function testMstTest():void {
      setup();
    ...
    //  |  |  |  
    //  e  f  g
    public function testBfsTest():void {
      setup();
    ...
    // a-b-c-d-g-f-e
    public function testDfsTest():void {
      setup();
    ...
    //  |  |  |  
    //  e  f  g
    public function testBfsTwiceTest():void {
      setup();
      data.treePolicy = TreeBuilder.BREADTH_FIRST;
      data.root = c;
      var tree:Tree = data.tree;
